...
racial disparities in incarceration—policymakers should consider how to
productively reform the current penal system. To this end, the analysis in this
report will highlight existing problem areas that could serve as a starting
