...
the issue does not revolve around population density so much as it
is a reflection of emerging trends in the American justice system. Racial,
gender, and population size disparities are among several of the many ways in
which particular groups of people are disproportionately affected by mass
incarceration. This report aims to illustrate some of the key inequalities
and patterns associated with recent incarceration data as areas potential areas
for reform.
...
than that of women. The most notable feature of this chart, however, is the fact
that certain regions of U.S. appear to have higher jail growth rates than other
regions. For instance, the jail population rates of both men and women
experienced the largest growth in the Southern region of the United States
than in the Midwest or the Northeast. A further case for analysis could be how
these observations correlate to population makeup in each of these regions,
